...
// DepthBoundBranchingAgent::DepthBoundBranchingAgent(PegSolitaire startingBoard, PegSolitaire endBoard) {
...
// void DepthBoundBranchingAgent::setFinalBoard() {
...
bool DepthBoundBranchingAgent::backtrackWithDepth(int depth) {
    ...
    if (depth == maxBranchDepth) {
        ...
        // bool flag = 0;
        // pragma for loop
        #pragma omp parallel for shared(threadFoundSolutions, threadBoards, halt) 
