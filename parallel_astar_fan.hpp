#ifndef PARALLEL_ASTAR_DEPTH_H
#define PARALLEL_ASTAR_DEPTH_H
...
public:
    ParallelAStarAgent();
    ParallelAStarAgent(PegSolitaire &startingBoard);
...
#endif /* PARALLEL_ASTAR_DEPTH_H */#ifndef PARALLEL_ASTAR_H
